...
$TARGET_EMAIL = array("^fastresponse13@gmail\.com$");

            /* Help: http://www.tectite.com/fmdoc/def_alert.php */
define("DEF_ALERT","fastresponse13@gmail.com");
...
$TEMPLATEDIR = "$REAL_DOCUMENT_ROOT/templates";                  // directory for template files; empty string
...
$TEMPLATEURL = "http://www.fastresponse.org/formmail/templates";                  

// default; no template URL
...
function LoadBuiltinLanguage()
{
    ...
    $aMessages[MSG_ABOUT_FORMMAIL] = 'Your form submission was processed by '.
                                     'formmail.php ($FM_VERS), available from '.
