...
$i = 1;
    ...
    echo '  { "date": "'; echo date("Y-m-d H:i:00",strtotime($initTime. ' + 1 days')); echo '", "type": "class-start", "title": "EMT Class Begins", "description": "Our full-time EMT class will be starting today.", "url": "/classes/career_courses/emt/" },';

    echo '  { "date": "'; echo date("Y-m-d H:i:00",strtotime($initTime. ' + 1 days')); echo '", "type": "class-start", "title": "CPT Class Begins", "description": "", "url": "" },';
