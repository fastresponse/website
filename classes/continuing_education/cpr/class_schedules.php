  ...
  <div class="body">
    ...
    <div>
      ...
      <ul>
        ...
        <li>Part 1: Web-based classroom including case-based scenarios, interactive activities, and videos.</li>
        <ul>
        ...
        <li>Parts 2 and 3: Skills practice and testing session.</li>
        <ul>
