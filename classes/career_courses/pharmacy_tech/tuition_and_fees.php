<div id="tuition_and_fees" class="module article-box">
  ...
  <div class="body">
    <table style="margin: 0 auto;" class="row-highlight">
      <tfoot>
        <tr><td>Total</td><td>$4,260.00</td><td></td></tr>
      </tfoot>
      <tbody>
        ...
        <tr><td>STRF</td><td>$2.00</td><td class="notes-col">Non-Refundable ($0.50 for every $1000.00, rounded to the nearest $1000.00.)</td></tr>
      </tbody>
    </table>
    <table style="margin: 20px auto 0;" class="row-highlight">
      ...
      <tbody>
        ...
        <tr><td>Live Scan</td><td>$69.00</td><td class="notes-col">Required, price varies by county</td></tr>
