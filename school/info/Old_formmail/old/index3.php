...
<title>Fast Response School of Healthcare Education Inquiries</title>
</head>
...
<form method="post" action="http://www.fastresponse.org/formmail/formmail.php?<?php if (defined("SID")) echo SID; ?>" name="Welcome to Fast Response">
  ...
  Subject=Welcome to Fast Response,TemplateMissing=" />
...
<!--
    ...
    &nbsp;
    <textarea name="how_hear_specific" rows="5" cols="25" style="color: #663300; margin-bottom: 20px;"></textarea>  <br />  <br />     </td>
      </tr>
	   <tr>
        <td><p><strong>When is the best time to reach you?</strong></p></td>
        <td>
		&nbsp;&nbsp;
		Morning 
        <input type="checkbox" name="whenreachme[]2" value="Morning" />
&nbsp;&nbsp;&nbsp;
   
      Afternoon
      <input type="checkbox" name="whenreachme[]" value="Afternoon" />
     &nbsp;&nbsp;
	
     Evening
      <input type="checkbox" name="whenreachme[]" value="Evening" />
      &nbsp;&nbsp; 
	
      	&nbsp;&nbsp;Weekends
        <input type="checkbox" name="whenreachme[]" value="Weekends" />
         &nbsp;&nbsp; 
	
      	&nbsp;&nbsp;No Preference
        <input type="checkbox" name="whenreachme[]" value="no preference" />
    </td>
      </tr>
		...
		<input type="text" name="street address 3" /> City, State, Zip Code<br>	
        <br />	</td>
      </tr>
      <tr>
        <td valign="top"><p><strong>Please enter any <br>questions or comments:</strong></p></td>
        <td><br /><textarea name="comments" rows="10" cols="50"></textarea> <br><br></td></tr>
    ...
    <tr>
        ...
        enter the characters you see in the image:<br />
        <center>  <img src="http://www.fastresponse.org/formmail/verifyimg.php?<?php if (defined("SID")) echo SID; ?>" alt="Image verification" name="vimg" id="vimg" />&nbsp;&nbsp;
          <input type="text" size="12" name="arverify" />
         
         <a href="http://www.fastresponse.org/formmail/why.html" target="popup"
 onClick="wopen('http://www.fastresponse.org/formmail/why.html', 'popup', 640, 480); return false;"> Why?</a> 
         
         
         <!-- <a href="why.htm" target="_blank">Why?</a> -->
        </center></p>
        <br /><br />
        <small>If you cannot read the image, click for a new one&nbsp;
    ...
    <tr>
        ...
        <br /><br />
        <input type="submit" value="Submit" width="200px" />  <input type="hidden" name="good_url" value="http://fastresponse.org/school/thanks/" /> Click submit once.  <br /><br /><br /></td>
...
<br />
<center>
<img src="http://www.fastresponse.org/sites/all/themes/fastresponse/css/images/phonenumber.png" /></center>
<!-- /main -->
		<div id="classlinks">
